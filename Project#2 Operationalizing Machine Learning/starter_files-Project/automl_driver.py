...
workspace_name = "quick-starts-ws-129135" # PLACEHOLDER
subscription_id = "94e14ad4-bf97-47e8-aae0-f9b85a7befa8" # PLACEHOLDER
resource_group = "aml-quickstarts-129135" # PLACEHOLDER
experiment_name = "demo-experiment" # PLACEHOLDER
iteration = "48"  # PLACEHOLDER
run_id = "AutoML_97c4d747-1e14-48a1-be21-2a42f5e200a2_48"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'culster-demo-ml','enable_dnn':False,'experiment_exit_score':None,'experiment_timeout_minutes':60,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':60,'max_concurrent_iterations':5,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'demo-experiment','path':'./sample_projects/demo-experiment','primary_metric':'AUC_weighted','region':'southcentralus','resource_group':'aml-quickstarts-129135','subscription_id':'94e14ad4-bf97-47e8-aae0-f9b85a7befa8','task_type':'classification','validation_size':None,'vm_type':'STANDARD_DS12_V2','workspace_name':'quick-starts-ws-129135','label_column_name':'y','enable_pushmode_remote':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'AUC_weighted','ensemble_iterations':15,'is_timeseries':False,'name':'demo-experiment','compute_target':'culster-demo-ml','subscription_id':'94e14ad4-bf97-47e8-aae0-f9b85a7befa8','region':'southcentralus'}\",\"ensemble_run_id\":\"AutoML_97c4d747-1e14-48a1-be21-2a42f5e200a2_48\",\"experiment_name\":\"demo-experiment\",\"workspace_name\":\"quick-starts-ws-129135\",\"subscription_id\":\"94e14ad4-bf97-47e8-aae0-f9b85a7befa8\",\"resource_group_name\":\"aml-quickstarts-129135\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"56b61312-82f5-457c-9ed8-21e05780e168\"}}" # PLACEHOLDER
